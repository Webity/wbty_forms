...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_forms&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="field_type-form" class="formview form-validate form-horizontal">
    <?php echo $this->addToolbar(); ?>
    <div class="clr"></div>
    <div class="row-fluid">
    	<div class="span12">
    		<fieldset class="adminform parentform" data-controller="field_type" data-task="field_type.ajax_save">
    			<legend><?php echo JText::_('COM_WBTY_FORMS_LEGEND_FIELD_TYPE'); ?></legend>
                <div class="items">
                    <?php 
