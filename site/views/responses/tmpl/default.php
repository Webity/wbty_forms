...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_forms&view=responses'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<h2 class="title centered"><?php echo JText::_('Responses'); ?></h2>
	<div class="clr"></div>
	...
	<table class="adminlist table table-striped table-bordered">
		<thead>
			<tr>
				...
				<th></th>
					...
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_FORMS_FORM_LBL_RESPONSES_FORM_ID', 'validation_types.form_id', $listDirn, $listOrder); ?>
					</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="center">
                	<div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <?php
                        echo '<li><a href="index.php?option=com_wbty_forms&view=response&layout=default&id='.$item->id.'">View</a></li>';
						if ($canEdit && $this->state->get('filter.state') != -2) {
	                        echo '<li><a href="index.php?option=com_wbty_forms&task=response.edit&id='.$item->id.'">Edit</a></li>';
						}
                        ?>
						...
						<td>
							...
							<?php endif; ?>
							<?php echo $this->escape($item->form_id); ?>
						</td>
						
						<td>
							<?php echo $item->submission_time; ?>
						</td>
				...
				<td>
					<?php echo (int) $item->response_values; ?>
				</td>
