...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_forms&view=forms'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<h2 class="title centered"><?php echo JText::_('Forms'); ?></h2>
	<div class="clr"></div>
		...
		<thead>
			<tr>
				...
				<th></th>
					...
					<th>
						<?php echo JHtml::_('grid.sort',  'COM_WBTY_FORMS_FORM_LBL_FORMS_NAME', '.name', $listDirn, $listOrder); ?>
					</th>
                ...
                <td class="center">
                	<div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <?php
                        echo '<li><a href="index.php?option=com_wbty_forms&view=form&layout=default&id='.$item->id.'">View</a></li>';
						if ($canEdit && $this->state->get('filter.state') != -2) {
	                        echo '<li><a href="index.php?option=com_wbty_forms&task=form.edit&id='.$item->id.'">Edit</a></li>';
						}
                        ?>
