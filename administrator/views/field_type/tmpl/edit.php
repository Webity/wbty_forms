...
<form action="<?php echo JRoute::_('index.php?option=com_wbty_forms&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="field_type-form" class="form-validate form-horizontal">
    <div class="row-fluid">
        <div class="span12">
