...
class Wbty_formsHelper
{
	...
	public static function addSubmenu($vName = '')
	{
		...
		JSubMenuHelper::addEntry(
			JText::_('COM_WBTY_FORMS_TITLE_CONTROLPANEL'),
			'index.php?option=com_wbty_forms&view=controlpanel',
			$vName == 'controlpanel'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_WBTY_FORMS_TITLE_FORMS'),
			'index.php?option=com_wbty_forms&view=forms',
			$vName == 'forms'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_WBTY_FORMS_TITLE_RESPONSES'),
			'index.php?option=com_wbty_forms&view=responses',
			$vName == 'responses'
		);
	}
